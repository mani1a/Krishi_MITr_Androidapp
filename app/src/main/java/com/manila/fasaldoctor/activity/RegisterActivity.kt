...
//            val farmer = (checkedId == R.id.farmer).toString()
//            val expert = (checkedId == R.id.expert).toString()
            var farmer = "farmer"
            var expert = "expert"
...
//            radioRoleGroup.setOnCheckedChangeListener { _, checkedId ->
//
//                if (checkedId == R.id.farmer) {
//                    firebaseDatabaseReference.child("Farmer").child(userName).setValue(userFarmer)
//                        .addOnCompleteListener {
//                            if (it.isSuccessful) { Toast.makeText(this, "Profile Updated as Farmer", Toast.LENGTH_SHORT).show()
//                            }
//                            else {
//                                Toast.makeText(this, "Something Error Occurred", Toast.LENGTH_SHORT)
//                                    .show()
...
//
//                if (checkedId == R.id.expert) {
//                    firebaseDatabaseReference.child("Expert").child("ee").setValue(userExpert)
//                        .addOnCompleteListener {
//                            if (it.isSuccessful) {
//                                Toast.makeText(this,"Profile Updated as expert", Toast.LENGTH_SHORT).show()
//                            } else {
