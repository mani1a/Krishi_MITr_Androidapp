...
class FilteredUserAdapter (private var  context: Context, private var recentUserList : ArrayList<RecentUser>):
    RecyclerView.Adapter<FilteredUserAdapter.Viewholder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Viewholder {
        ...
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.recyclerview_users, parent, false)
